...
Quite often when we are developing an application we will need some external services such as a rabbitMQ, Kafka, ...
...
Luckily Spring Boot 3.1 introduced some nice improvements to make our live a bit easier.
